...
## Informations
* This docker-airflow build is a modified version of [puckel/docker-airflow](https://github.com/puckel/docker-airflow)
* Added auto admin user creation and enabled login screen.
* Admin user detail user: admin password: admin
...
Pull the image from the Docker repository.
    ...
    docker pull noob41/docker-airflow

## Build

Optionally install [Extra Airflow Packages](https://airflow.incubator.apache.org/installation.html#extra-package) and/or python dependencies at build time :

    docker build --rm --build-arg AIRFLOW_DEPS="datadog,dask" -t noob41/docker-airflow .
    docker build --rm --build-arg PYTHON_DEPS="flask_oauthlib>=0.9" -t noob41/docker-airflow .

or combined

    docker build --rm --build-arg AIRFLOW_DEPS="datadog,dask" --build-arg PYTHON_DEPS="flask_oauthlib>=0.9" -t noob41/docker-airflow .
...
By default, docker-airflow runs Airflow with **SequentialExecutor** :
    ...
    docker run -d -p 8080:8080 noob41/docker-airflow webserver
...
`LOAD_EX=n`
    ...
    docker run -d -p 8080:8080 -e LOAD_EX=y noob41/docker-airflow
